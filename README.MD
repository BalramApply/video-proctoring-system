Here’s the **fitted `README.md`** with your API routes cleaned up, correct markdown formatting, and including **sample `.env` files** for both frontend & backend so new developers can set it up easily:
